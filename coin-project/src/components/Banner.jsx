...
const Banner = () => {
  return (
    <div className="mt-10 text-white dark:text-black centering justify-between lg:w-[90%]">
      <div className="w-[95%] md:w-[60%] lg:w-1/2 mx-auto md:mr-10 font-vazirMedium lg:ml-5">
        ...
        <p className="text-gray-400 dark:text-gray-700 font-vazirRegular my-5">
        ...
        <button className="w-full h-14 button bg-blue-600 border-blue-600 dark:border-blue-600 dark:text-white">
          شروع کنید
        </button>

        <div className="w-full centering justify-between mt-3 font-vazirRegular">
          <button className="button h-14 w-1/2 ml-1 centering dark:font-bold">
            <FaApple className="text-2xl ml-1" />
            <span className="text-xs sm:text-base">دانلود وب اپلیکیشن IOS</span>
          </button>

          <button className="button h-14 w-1/2 mr-1 centering dark:font-bold">
