...
const Cards = () => {
  return (
    <div className="mt-32 pb-10 max-w-[90%] sm:max-w-[70%] lg:max-w-[85%] mx-auto font-vazirMedium">
      <h1 className="text-white text-center mb-7 text-[22px] lg:text-[26px] font-black">
        پلتفرم حرفه ای خرید و فروش ارز دیجیتال
      </h1>

      <h5 className="text-center mb-14 text-sm 1120:text-lg text-gray-400 font-vazirRegular">
